  ...
  return (
    <div className="absolute inset-0 pointer-events-none perspective-[1000px]">
      ...
      <div className="absolute inset-x-0 bottom-[-5%] md:bottom-[-10%] top-24 md:top-32 w-full flex flex-col items-center justify-center transform-style-preserve-3d transition-all duration-700 ease-out group-hover:scale-[1.03]">
        ...
        {/* MACBOOK (Left/Back) */}
        <div className="absolute z-10 left-[2%] md:left-[8%] top-[35%] md:top-[30%] w-[140px] md:w-[260px] h-[90px] md:h-[160px] rounded-t-lg md:rounded-t-2xl border-[2px] md:border-[3px] border-zinc-700/40 bg-zinc-950/95 shadow-2xl flex flex-col p-1.5 md:p-2 transform -rotate-[15deg] transition-all duration-700 group-hover:-rotate-[-5deg] group-hover:-translate-y-4 backdrop-blur-xl border-b-0">
